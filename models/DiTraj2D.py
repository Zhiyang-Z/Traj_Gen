...
from models.patchify import PatchEmbed2D
from models.attention import VanillaAttention
from models.pos_emb import get_2d_sincos_pos_embed
...
class DiTraj2D(nn.Module):
    ...
    def __init__(
        ...
        self.x_embedder = PatchEmbed2D(img_width=traj_length, patch_size=patch_size, embed_dim=hidden_size)
