...
from models.patchify import PatchEmbed
...
class DiTraj(nn.Module):
    ...
    def __init__(
        ...
        self.x_embedder = PatchEmbed(img_width=traj_length, patch_size=patch_size, embed_dim=hidden_size)
