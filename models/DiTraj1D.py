...
from models.patchify import PatchEmbed1D
...
class DiTraj1D(nn.Module):
    ...
    def __init__(
        ...
        self.x_embedder = PatchEmbed1D(traj_length=traj_length, patch_size=patch_size, in_chans=in_channels, embed_dim=hidden_size)
    ...
    def unpatchify(self, x):
        ...
        imgs = x.reshape(shape=(x.shape[0], c, self.x_embedder.out_length * p))
        return imgs
